...
RSpec.feature "Users", type: :feature do
  context 'create new guest' do
    ...
    scenario "Guest user is created with email and password, which are ignored after creation" do
      visit new_user_path
      # Fill out form with guest user details including email/password
      check 'click to create guest experience' # it's a checkbox
      ...
      #  confirm email and password were blanked/stored as nil
